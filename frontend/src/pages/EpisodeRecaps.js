...
function EpisodeRecap() {
  return (
    ...
    <div className='flex justify-between md:px-[70px] pt-4 font-sans px-4'>
        <p className='font-semibold md:text-[35px] md:leading-[47.66px] text-[#000000] text-[14px]'>Hierachy Episodes 1-2 Recap</p>
      <p className='font-semibold text-[#7F56DA] md:leading-[24.51px] md:text-[18px] text-[14px]'>June 9th, 2024</p>
    </div>
    <div className='pt-9'>
          ...
          <div key={index} position={[location.lat, location.lon]}>
            <div>
              <div className="text-center px-4 md:px-[70px]">
               ...
               <div className=''> <h4 className=" pt-4 pb-4 font-normal text-justify md:leading-[30.8px] leading-[20.8px] md:text-[22px] text-[14px] text-[#000000]">{location.text}</h4></div>
              </div>
            </div>
          </div>
        ))}
