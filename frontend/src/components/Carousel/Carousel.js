...
//     text: (
//       <div>
//         <h1 className="font-bold md:text-[40px] lg:text-[70px] md:leading-[55.33px] lg:leading-[95.33px]">Queen Of Tears</h1>
...
//     text: (
//       <div>
//         <h1 className="font-bold md:text-[40px] lg:text-[70px] md:leading-[55.33px] lg:leading-[95.33px]">Doctor Slump</h1>
//         <p className="md:w-[535.35px]  italic md:leading-[21.79px] font-normal  md:text-[16px] text-[8px]">
...
//         <h1 className="font-bold md:text-[40px] lg:text-[70px] md:leading-[55.33px] lg:leading-[95.33px]">The Escape of the Seven</h1>
...
//   return (
//     <div className="relative w-full md:h-[521px] h-[300px] overflow-hidden font-sans mt-20">
//       <div className="absolute inset-0 flex md:items-center md:justify-center">
//         <button
//           onClick={prevSlide}
//           className="absolute left-0 p-4 m-4 bg-opacity-50 rounded-full hover:bg-opacity-75 md:z-30 "
//         >
//           <img
//             src={leftArrow}
//             alt="Previous"
...
//         <button
//           onClick={nextSlide}
//           className="absolute right-0 p-4 m-4 bg-opacity-50 rounded-full hover:bg-opacity-75 md:z-30"
//         >
//           <img src={rightArrow} alt="Next" className="md:w-[25.8px] md:h-[43.13px] lg:w-[45.8px] lg:h-[83.13px] l w-3" />
//         </button>
//       </div>
  ...
  },
  {
    ...
    text: (
      <div>
        ...
        <p className="md:w-[535.35px] italic md:leading-[21.79px] font-normal md:text-[16px] text-[8px]">
          Once rivals in school, two brilliant doctors reunite by chance — each
          facing life’s worst slump and unexpectedly finding solace in each
          other.
        </p>
      </div>
    ),
  },
  {
    ...
    text: (
      <div className="md:mt-[120px]">
        ...
        <p className="md:w-[535.35px] md:pl-4 italic md:leading-[21.79px] font-normal md:text-[16px] text-[8px]">
          The mysterious disappearance of a girl brings together seven people
          from all different walks of life. They all have an intertwined
          connection to her disappearance in the most horrific, unfathomable,
          and despicable way. As money drives them to their greed, lies, and
          delirium, they face divine retribution as they struggle for their
          lives in a picturesque revenge. How far will they go to claim their
          innocence, and will anyone make it out alive?
        </p>
      </div>
    ),
  },
