...
import  MoviesComments from './moviesComments/moviesComments'
...
<div className="container mx-auto p-4 font-sans">
 ...
 <p className=' font-bold text-[2s0px] md:text-[37px] w-full md:leading-[47.66px] md:pb-6 pb-1'>
        ...
        <div className='flex gap-3 items-center mt-6'>
         ...
         <button className='flex items-center justify-center bg-[#7F56DA] text-white p-2 rounded-md'>See Recaps</button>
        </div>
         <p>
         ...
         <p>
             Genre: family, human, rom-com, workplace
         </p>
         </div>
         <div>
     ...
     <p className=" md:mb-9 md:mt-2 mb-3 mt-1 font-bold text-[20px] md:text-[37px] w-full md:leading-[47.66px]  ">Trending now</p>
       ...
       {trendingItems.map((item, index) => (
         <div key={index} className="flex flex-col items-center  border border-gray-300'">
          <img src={item.image} alt='' className='justify-center  object-cover p-2' />
            <p className=' w-full p-2 font-bold text-[14px] md:pl-5'>
                     {item.title}
            </p>
