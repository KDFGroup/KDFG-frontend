...
//   return (
//     <div className="flex flex-col justify-between md:px-[px] pt-4 font-sans px-4 pb-11">
...
function MoviesComments() {
  ...
  return (
    <div className="flex flex-col justify-between md:px-[px] pt-4 font-sans px-4 ">
      ...
      {selected === "comments" && (
        <form onSubmit={handleNewCommentSubmit} className="pt-5 justify-center gap-4 items-center flex flex-col">
          <input
            type="text"
            value={newComment}
