...
function Recap() {
  return (
    ...
    <div className='flex items-center justify-center '>
     <div><p className='w-[228px] font-semibold text-[33px]'>other Recaps</p></div>
       <div className='border-t w-full'></div>
    </div> 
      {cardData.map(card => (
        <div key={card.id} className='pt-4 pb-4 md:flex border-b '>
          <img src={card.image} alt={card.title} className='md:w-[196px] md:h-[196px] w-[100%] object-cover rounded-t-lg ' />
          <div className='p-4'>
